...
class CarSideLeft extends CGFobject
{
	constructor(scene)
	{
		super(scene);
		...
		this.part13 = new MyTrap(scene ,
										-0.3,0,0.75,
										7,0,0.75,
										7,0,0.75,this.N);

		this.part14 = new MyTrap(scene,
										0,1,0,
										3,0,-0.75,
										3,1,0,this.N);

		this.part15 = new MyTrap(scene,
										0,1.5,1,
										1,0,1,
										1,1.5,1,this.N);

		this.part16 = new MyTrap(scene,
										0,3,-1,
										1,0,0,
										1,3,0,this.N);


		this.part17 = new MyTrap(scene,
										-2,2.25,1,
										1,0,0,
										-2,3,1,this.N);

		this.part18 = new MyTrap(scene,
										0,0.75,0,
										8,0,0,
										8,0.75,0,this.N);

		this.part19 = new MyTrap(scene,
										0,0.75,0,
										0.5,-0.2,-0.165,
										0.5,0.75,0,this.N);
